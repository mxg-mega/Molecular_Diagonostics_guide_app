...
class PCRCleanUpProtocolScreen extends StatelessWidget {
  PCRCleanUpProtocolScreen({super.key});

  final List<String> sectionI = [
    "For very small sample volumes < 30 µL adjust the volume of the reaction mixture to 50-100 μL with water. It is not necessary to remove mineral oil.\n",
  ...
  Widget build(BuildContext context) {
    return SubScreenTemplate(
      screenTitle: "PCR Clean -up Gel Extraction",
